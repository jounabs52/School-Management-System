...
export const addPDFFooter = (doc, pageNumber = 1, totalPages = 1, pdfSettings = {}) => {
  ...
  // Left: Footer text from settings only (no hardcoded fallback)
  if (pdfSettings.includeFooter && pdfSettings.footerText) {
    doc.text(pdfSettings.footerText, 15, footerY)
  }

  // Center: Date & Time (respect includeDate setting)
  ...
  // Right: Page number (respect includePageNumbers setting)
